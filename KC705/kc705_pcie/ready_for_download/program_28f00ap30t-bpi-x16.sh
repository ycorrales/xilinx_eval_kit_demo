...
(
 set -eo pipefail
  ...
  sed -e "s:XXX_HARDWARE_TAG_XXX:${hardware_tag}:g" "program_28f00ap30t-bpi-x16_tcl" > "program_28f00ap30t-bpi-x16.tcl"
  vivado -notrace -nojournal -nolog  -mode batch -source program_28f00ap30t-bpi-x16.tcl

  FILE_LIST=('program_28f00ap30t-bpi-x16.tcl' 'webtalk*')
