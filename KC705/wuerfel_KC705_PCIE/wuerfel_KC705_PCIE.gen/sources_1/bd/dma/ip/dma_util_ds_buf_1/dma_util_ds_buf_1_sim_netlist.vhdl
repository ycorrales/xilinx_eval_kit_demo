...
--               /home/maps/nwuerfel/wuerfel_KC705_PCIE/wuerfel_KC705_PCIE.gen/sources_1/bd/dma/ip/dma_util_ds_buf_1/dma_util_ds_buf_1_sim_netlist.vhdl
...
entity dma_util_ds_buf_1_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of dma_util_ds_buf_1_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of dma_util_ds_buf_1_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of dma_util_ds_buf_1_util_ds_buf : entity is "ibufdsgte2";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of dma_util_ds_buf_1_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of dma_util_ds_buf_1_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of dma_util_ds_buf_1_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of dma_util_ds_buf_1_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of dma_util_ds_buf_1_util_ds_buf : entity is "util_ds_buf";
end dma_util_ds_buf_1_util_ds_buf;

architecture STRUCTURE of dma_util_ds_buf_1_util_ds_buf is
...
entity dma_util_ds_buf_1 is
  ...
  attribute NotValidForBitStream of dma_util_ds_buf_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of dma_util_ds_buf_1 : entity is "dma_util_ds_buf_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of dma_util_ds_buf_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of dma_util_ds_buf_1 : entity is "util_ds_buf,Vivado 2020.2";
end dma_util_ds_buf_1;

architecture STRUCTURE of dma_util_ds_buf_1 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN dma_util_ds_buf_1_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN dma_util_ds_buf_1_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.dma_util_ds_buf_1_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
