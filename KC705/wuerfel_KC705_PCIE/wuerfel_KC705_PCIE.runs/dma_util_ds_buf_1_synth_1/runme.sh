...
HD_PWD='/home/maps/nwuerfel/wuerfel_KC705_PCIE/wuerfel_KC705_PCIE.runs/dma_util_ds_buf_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_util_ds_buf_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_util_ds_buf_1.tcl
