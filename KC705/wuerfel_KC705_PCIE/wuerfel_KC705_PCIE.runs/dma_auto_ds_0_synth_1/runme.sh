...
HD_PWD='/home/maps/nwuerfel/wuerfel_KC705_PCIE/wuerfel_KC705_PCIE.runs/dma_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_auto_ds_0.tcl
